...
private:
    void onLoad() override
    {
        ...
        groundGeometry->primitive = OctalEngine::PrimitiveType::Plane;
        ...
        auto* cubeGeometry = cube.addComponent<OctalEngine::MeshGeometry>();
        cubeGeometry->primitive = OctalEngine::PrimitiveType::Cube;
