...
namespace
{
    ...
    const char* rendererTypeToString(OctalEngine::RendererType type)
    {
        switch (type)
        {
        case OctalEngine::RendererType::Auto:
            return "Auto";
        case OctalEngine::RendererType::Direct3D11:
            return "Direct3D 11";
        case OctalEngine::RendererType::Direct3D12:
            return "Direct3D 12";
        case OctalEngine::RendererType::OpenGL:
            return "OpenGL";
        case OctalEngine::RendererType::OpenGLES:
            return "OpenGL ES";
        case OctalEngine::RendererType::Vulkan:
            return "Vulkan";
        case OctalEngine::RendererType::Metal:
            return "Metal";
        case OctalEngine::RendererType::WebGPU:
            return "WebGPU";
        default:
            return "Unknown";
        }
...
int main()
{
    ...
    rendererSettings.rendererType = OctalEngine::RendererType::Vulkan;
    // You can specify a renderer type, e.g.:
    // rendererSettings.rendererType = OctalEngine::RendererType::Vulkan;
    // If not specified or unavailable, Auto will select the best available renderer
    ...
    // Log the active renderer type
    OctalEngine::RendererType activeType = renderer.getRendererType();
    std::cout << "Renderer initialized with: " << rendererTypeToString(activeType) << std::endl;
